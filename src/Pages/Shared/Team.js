        ...
        <div>
            <section className="bg-white dark:bg-gray-900">
                ...
                <div className="container px-6 py-8 mx-auto">
                    <h2 className="text-2xl font-semibold text-center text-indigo-500 capitalize lg:text-5xl dark:text-white">Meet our Flipphoe Team</h2>
                    ...
                    <div className="grid gap-8 mt-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        ...
                        <div className="w-full max-w-xs text-center">
                            ...
                            <div className="mt-2">
                                ...
                                <span className="mt-1 font-medium text-gray-600 dark:text-gray-300">Product manager</span>
                            </div>
                        </div>
                        ...
                        <div className="w-full max-w-xs text-center">
                            ...
                            <div className="mt-2">
                                ...
                                <span className="mt-1 font-medium text-gray-600 dark:text-gray-300">Marketing Officer</span>
                            </div>
                        </div>
                    </div>
                </div>
